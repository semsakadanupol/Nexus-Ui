 ...
 * width(50, 'vh') → 'w-50vh'
 */
export function width(value, unit = "px") {
    return `w-${value}${unit}`;
}
/**
 ...
 */
export function height(value, unit = "px") {
    return `h-${value}${unit}`;
}
/**
 ...
 * gap(2, 'rem') → 'gap-2rem'
 */
export function gap(value, unit = "px") {
 ...
 */
export function fontSize(value, unit = "px") {
 ...
 */
export function borderRadius(value, unit = "px") {
 ...
 */
export function minHeight(value, unit = "px") {
    return `min-h-${value}${unit}`;
}
export function maxHeight(value, unit = "px") {
 ...
 */
export function lineHeight(value, unit = "px") {
 ...
 */
export function letterSpacing(value, unit = "px") {
 ...
 */
export function wordSpacing(value, unit = "px") {
 ...
 */
export function padding(value, unit = "px") {
    return `p-${value}${unit}`;
}
export function paddingX(value, unit = "px") {
    return `px-${value}${unit}`;
}
export function paddingY(value, unit = "px") {
    return `py-${value}${unit}`;
}
export function paddingTop(value, unit = "px") {
    return `pt-${value}${unit}`;
}
export function paddingBottom(value, unit = "px") {
    return `pb-${value}${unit}`;
}
export function paddingLeft(value, unit = "px") {
    return `pl-${value}${unit}`;
}
export function paddingRight(value, unit = "px") {
 ...
 */
export function margin(value, unit = "px") {
    return `m-${value}${unit}`;
}
export function marginX(value, unit = "px") {
    return `mx-${value}${unit}`;
}
export function marginY(value, unit = "px") {
    return `my-${value}${unit}`;
}
export function marginTop(value, unit = "px") {
    return `mt-${value}${unit}`;
}
export function marginBottom(value, unit = "px") {
    return `mb-${value}${unit}`;
}
export function marginLeft(value, unit = "px") {
    return `ml-${value}${unit}`;
}
export function marginRight(value, unit = "px") {
 ...
 */
export function positionTop(value, unit = "px") {
    return `top-${value}${unit}`;
}
export function positionRight(value, unit = "px") {
    return `right-${value}${unit}`;
}
export function positionBottom(value, unit = "px") {
    return `bottom-${value}${unit}`;
}
export function positionLeft(value, unit = "px") {
